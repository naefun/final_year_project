...
class DateUtilities{
    ...
    if(futureYear == null || futureMonth == null || futureDay == null ||
    DateUtils.getDaysInMonth(futureYear, futureMonth) < futureDay || futureDay <=0 ||
    futureMonth <=0 || futureMonth > 12 || futureYear <= 0){
      return null;
    }
  ...
  static bool validDate(String date){
    ...
    if (futureMonth == null || futureMonth > 12 || futureMonth <= 0) return false;
    if (futureDay == null || futureDay <= 0) return false;
    if(DateUtils.getDaysInMonth(futureYear, futureMonth) < futureDay) return false;
